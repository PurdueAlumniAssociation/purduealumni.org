...
echo "<div class=\"col-xs-12 col-sm-6 col-md-4 col-lg-3 card-container\" data-150-categories=\"{$data_categories_string}\" data-object-id=\"".get_the_ID()."\">
    <a href=\"".get_the_permalink()."\" class=\"card card--150-item card--fadeinup\">
        ...
        <div class=\"card__content card__content--150-item\">
            <h3 class=\"card__title card__title--150-item\">".get_the_title()."</h3>
        </div>
    </a>
</div>";
