...
if ( ! empty($memberships) ) {
    ...
    switch ($effective_membership->status) {
        ...
        case "wcm-expired":
            ...
            break;
        case "wcm-cancelled":
            $message = "<p>Your membership is cancelled! <a href=\"https://www.purduealumni.org/membership/\">Purchasing a new membership to regain access to member benefits</a>. Because you are already logged in, any information saved in your profile will be automatically filled out during checkout.</p>";
            break;
        case "wcm-paused":
