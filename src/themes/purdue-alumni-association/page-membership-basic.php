...
<main id="main" tabindex="-1">
    ...
    <section class="row row--cards-3">
        <div class="flex-item-1-2-3">
            <a href="https://purdue.imodules.com/s/1461/alumni/index.aspx?sid=1461&gid=1001&pgid=9078" >
                <div class="card card--flex-item-3">
                    <img class="card__image" src="../../images/300x200Small19.jpg" alt="">
        ...
        <div class="flex-item-1-2-3">
            <a href="https://purdue.imodules.com/s/1461/alumni/index.aspx?sid=1461&gid=1001&pgid=9175" >
                <div class="card card--flex-item-3">
                    <img class="card__image" src="../../images/300x200Small.jpg" alt="">
                    <div class="card__content">
        ...
        <div class="flex-item-1-2-3">
            <a href="https://purdue.imodules.com/s/1461/alumni/index.aspx?sid=1461&gid=1001&pgid=9084" >
                <div class="card card--flex-item-3">
                    <img class="card__image" src="../../images/300x200Small3.jpg" alt="">
                    <div class="card__content">
