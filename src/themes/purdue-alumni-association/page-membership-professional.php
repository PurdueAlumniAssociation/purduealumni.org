            ...
            <div class="plan-details__benefits plan-details__benefits--professional">
                ...
                <div class="plan-details__button-row">
                    <div class="plan-details__button-row-container">
                        <p>1-Year</p>
                        <a class="button button--gold button--small plan-details__CTA" href="https://secure.ud.purdue.edu/s/1461/alumni/index.aspx?sid=1461&gid=1001&pgid=8945&cid=23100&pc=PR1YR" >$<?= $price1 ?></a>
                    </div>
                    <div class="plan-details__button-row-container">
                        <p>3-Years</p>
                        <a class="button button--gold button--small plan-details__CTA" href="https://secure.ud.purdue.edu/s/1461/alumni/index.aspx?sid=1461&gid=1001&pgid=8945&cid=23100&pc=PR3YR" >$<?= $price3 ?></a>
                    </div>
                    <?php if ( ! isset( $_GET['recent-grad'] ) ) : ?>
                    <div class="plan-details__button-row-container">
                        <p>10-Years</p>
                        <a class="button button--gold button--small plan-details__CTA" href="https://secure.ud.purdue.edu/s/1461/alumni/index.aspx?sid=1461&gid=1001&pgid=8945&cid=23100&pc=PR10YR" >$<?= $price10 ?></a>
                    </div>
                <?php endif; ?>
                </div>
