    ...
    <header class="black-bar">
        <nav class="black-bar-menu">
            <ul id="menu-black-bar-links" class="black-bar-menu__list">
                ...
                <li class="black-bar-menu__list-item"><a class="button button--gold button--bold button--small" href="https://www.purduealumni.org/membership/membership-plans">Join Now</a></li>
            </ul>
        </nav>
