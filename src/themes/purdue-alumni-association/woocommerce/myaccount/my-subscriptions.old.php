...
<div class="woocommerce_account_subscriptions">
	...
	<thead>
		<tr>
            <?php /*<th class="subscription-id order-number"><span class="nobr"><?php esc_html_e( 'Subscriptions', 'woocommerce-subscriptions' ); ?></span></th>*/ ?>
	...
	<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
		<tr class="order">
			<td class="subscription-id order-number" data-title="<?php esc_attr_e( 'ID', 'woocommerce-subscriptions' ); ?>">
				<?php /* <a href="<?php //echo esc_url( $subscription->get_view_order_url() ); ?>"><?php //echo esc_html( sprintf( _x( '#%s', 'hash before order number', 'woocommerce-subscriptions' ), $subscription->get_order_number() ) ); ?></a> */ ?>
